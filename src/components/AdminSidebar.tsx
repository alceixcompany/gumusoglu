  ...
  return (
    <>
      ...
      <div className="relative z-40 lg:hidden">
        {isMobileOpen && (
          <div className="fixed inset-0 bg-[#171719]/60 backdrop-blur-sm" />
        )}
        
        {/* Mobile sidebar */}
        <div className={`fixed inset-y-0 left-0 z-50 w-72 border-r border-white/10 bg-[#171719] shadow-[0_28px_80px_rgba(15,42,67,0.34)] transform transition-transform duration-300 ease-in-out ${
          isMobileOpen ? 'translate-x-0' : '-translate-x-full'
        }`}>
          <div className="flex h-20 items-center justify-between border-b border-white/10 px-5">
            <div><h1 className="text-base font-black tracking-[-.02em] text-white">Gümüşoğlu Elektrik</h1><p className="mt-1 text-[9px] font-bold uppercase tracking-[.2em] text-[#e30613]">Yönetim paneli</p></div>
            <button
          ...
          {user && (
            <div className="mx-4 mt-5 rounded-2xl border border-white/10 bg-white/[.06] p-3">
              <div className="flex items-center">
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#e30613]">
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center gap-3 rounded-xl px-4 py-3 text-left transition-all ${
                      pathname === item.href
                        ? 'bg-[#e30613] text-white shadow-[0_10px_24px_rgba(227,6,19,.3)]'
      ...
      <div className="hidden lg:flex lg:flex-shrink-0">
        <div className="flex h-screen w-72 flex-col border-r border-[#19191b] bg-[#171719] shadow-[16px_0_40px_rgba(32,32,34,.08)]">
          <div className="flex h-24 items-center border-b border-white/10 px-7">
            <div><h1 className="text-lg font-black tracking-[-.025em] text-white">Gümüşoğlu Elektrik</h1><p className="mt-1.5 text-[9px] font-bold uppercase tracking-[.22em] text-[#e30613]">Yönetim paneli</p></div>
          </div>
          ...
          {user && (
            <div className="mx-5 mt-6 rounded-2xl border border-white/10 bg-white/[.06] p-4">
              <div className="flex items-center">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#e30613] shadow-[0_8px_20px_rgba(227,6,19,.3)]">
                  <FiUser className="w-4 h-4 text-white" />
                </div>
                <div className="ml-3">
      ...
      <div className="lg:hidden mobile-menu-container">
        <button
          onClick={toggleMobileMenu}
          className="fixed left-4 top-4 z-50 rounded-xl border border-white/10 bg-[#171719] p-2.5 shadow-[0_18px_48px_rgba(15,42,67,.24)]"
        >
